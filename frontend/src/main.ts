...
const CV = {
    ...
    profile:
        "Étudiant en Master Sciences Actuarielles (ULB) avec un fort background mathématique (UNamur). Passionné par la modélisation stochastique et l'ingénierie logicielle appliquée à la finance. Rigueur théorique et compétences pratiques en C++ et Python.",
    skills: [
        {
    ...
    projects: [
        {
            ...
            codeUrl:
                'https://github.com/aldjoted/Mathematical-Modeling-Of-Infectious-Diseases-V1'
        },
        {
            ...
            codeUrl:
                'https://www.dropbox.com/scl/fo/gk7u4tg2eicwpmgedfep4/AN7WRkEu9yee6olaEJCt6GU?rlkey=qwvapkfz5ofc54ayqxdmrt2h3&st=aq9c3ffi&dl=0'
        },
        {
...
function renderProjects(): void {
    ...
    for (const project of CV.projects) {
        ...
        const link = el('a', 'btn btn-outline') as HTMLAnchorElement;
